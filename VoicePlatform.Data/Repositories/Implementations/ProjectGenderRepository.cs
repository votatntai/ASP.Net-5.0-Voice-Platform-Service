...
{
    public class ProjectGenderRepository : Repository<ProjectGender>, IProjectGenderRepository
    {
        public ProjectGenderRepository(AppDbContext context) : base(context)
        {
