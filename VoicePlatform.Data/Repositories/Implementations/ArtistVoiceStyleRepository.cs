...
{
    public class ArtistVoiceStyleRepository:Repository<ArtistVoiceStyle>, IArtistVoiceStyleRepository
    {
        public ArtistVoiceStyleRepository(AppDbContext context) : base(context)
        {
